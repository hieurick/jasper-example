...
public class ReportService {
	...
	public HttpEntity getReport(LocalDate date, String type) throws IOException {
		...
		reportDTO1.setDepName("Application Engineering");
		reportDTO1.setOrgName("Millennium IT");
		reportDTO1.setDevName("Admin");
		reportDTO1.setGroupName("EAD");
		reportDTO1.setDayStart(LocalDate.now().minusDays(31).toString());
		reportDTO1.setDayEnd(LocalDate.now().minusDays(1).toString());

		List<ReportDTO> records = new ArrayList<ReportDTO>();
		records.add(reportDTO);
		records.add(reportDTO1);
