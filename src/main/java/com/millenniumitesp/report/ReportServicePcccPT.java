...
@Service
@Transactional
public class ReportServicePcccPT {

	private final Logger log = LoggerFactory.getLogger(ReportServicePcccPT.class);

	@Autowired
	public ReportServicePcccPT() {
	}

	public HttpEntity getReport(LocalDate date, String type) throws IOException {
		String reportName = "test_report";

		// Creating VehicleInfo instance for testing purpose
		VehicleInfo VehicleInfo = new VehicleInfo();
		VehicleInfo.setName("Application Engineering");
		VehicleInfo.setImei("Millennium IT");
		VehicleInfo.setNumberSign("30Y2-4894");
		VehicleInfo.setDescription("EAD");
		VehicleInfo.setCreateDate(new Date());
		VehicleInfo.setModifiedDate(new Date());
		
		// Creating VehicleInfo instance for testing purpose
		VehicleInfo VehicleInfo1 = new VehicleInfo();
		VehicleInfo1.setName("Application Engineering2");
		VehicleInfo1.setImei("Millennium IT2");
		VehicleInfo1.setNumberSign("30Y2-4894");
		VehicleInfo1.setDescription("EAD2");
		VehicleInfo1.setCreateDate(new Date());
		VehicleInfo1.setModifiedDate(new Date());

		
		VehicleInfo VehicleInfo2 = new VehicleInfo();
		VehicleInfo2.setName("Application Engineering3");
		VehicleInfo2.setImei("Millennium IT3");
		VehicleInfo2.setNumberSign("30Y2-4894");
		VehicleInfo2.setDescription("EAD2");
		VehicleInfo2.setCreateDate(new Date());
		VehicleInfo2.setModifiedDate(new Date());
		
		List<VehicleInfo> records = new ArrayList<VehicleInfo>();
		records.add(VehicleInfo);
		records.add(VehicleInfo1);
		records.add(VehicleInfo2);
		// new jasper collection of VehicleInfo
		JRBeanCollectionDataSource jasperRecordsDataSource = new JRBeanCollectionDataSource(records);

		// jasper report implementation
		InputStream employeeReportStream = getClass().getResourceAsStream("/VehicleInfoTemp.jrxml");
		try {
